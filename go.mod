module github.com/liquidmetal-dev/cluster-api-provider-microvm

go 1.24.0

toolchain go1.24.12

// Align cluster-api and cluster-api/test; see https://github.com/kubernetes-sigs/cluster-api/pull/4765
